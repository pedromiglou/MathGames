...
function GameModal(props) {
  ...
  if (storage.gameMode==="No mesmo Computador") {
    ...
    if (endMode==="reached_goal") {
      text+=EndGameStatements.win[0].reached_goal;
    } else if (endMode==="no_moves") {
      text+=EndGameStatements.win[0].no_moves;
    ...
    if (winner==="win") {
      ...
      text+="Derrota. ";
      if (endMode==="no_moves") {
        text+=EndGameStatements.loss[0].no_moves;
      } else if (endMode==="timeout") {
