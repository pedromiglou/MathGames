...
db.tournament_matches.belongsTo(db.game_match, {through: "game_match", foreignKey: 'lastGame1', as: 'lastgame1'})
db.tournament_matches.belongsTo(db.game_match, {through: "game_match", foreignKey: 'lastGame2', as: 'lastgame2'})
db.tournament_matches.belongsTo(db.game_match, {through: "game_match", foreignKey: 'nextGame', as: 'nextgame'})
